...
User.prototype.addSavedPost = function(id2, title2, rating2) {
  let obj = {id: id2, title: title2, rating: rating2}
...
// Code here
User.prototype.removeSavedPost = function(id2) {
  for (let i = 0; i < this.savedPosts.length; i++) {
    if (this.savedPosts[i].id === id2) {
...
// Code here
User.prototype.changePostRating = function(id2, newRating) {
  for (let i = 0; i < this.savedPosts.length; i++) {
    if (this.savedPosts[i].id === id2) {
